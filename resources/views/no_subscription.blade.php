		...
		<div class="card">
			<div class="card-header" style="background-color: red">
				<div class="col text-center">
					<h3 class="card-title mr-5 text-white">No Subscription Found</h3>
				</div>
			</div>
			<div class="card-body text-center">
				...
				<div class="alert alert-danger" role="alert">
					<i class="fa fa-exclamation mr-2" aria-hidden="true"></i> It appears you are yet to subscribe. Please contact the site Admistrator.
				</div>
			</div>
